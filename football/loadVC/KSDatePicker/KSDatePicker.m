...
- (void)layoutSubviews
{
    ...
    /*{
        _middleView.frame= CGRectMake(0, _appearance.headerHeight, supWidth, AdaptationH(106-27));
   ...
   /* {
    ...
    {
        _currentDataSuperView.frame=CGRectMake(0, AdaptationH(38), supWidth, AdaptationH(41));
